...
export const traits_season_10 = {
  Set10_Emo: {
    apiName: 'Set10_Emo',
    desc: {
      ko: '이모코어 챔피언의 스킬 마나 소모량이 감소하고 아군이 죽을 때마다 마나를 얻습니다.<br><br><row>(@MinUnits@) @InitialMana@% 감소, @StackingMana@ %i:scaleMana% 획득</row><br><row>(@MinUnits@) @InitialMana@% 감소, @StackingMana@ %i:scaleMana% 획득</row><br><row>(@MinUnits@) @BonusAP@ %i:scaleAP%; @InitialMana@% 감소, @StackingMana@ %i:scaleMana% 획득 </row>',
  ...
  Set10_8Bit: {
    apiName: 'Set10_8Bit',
    desc: {
      ko: '8비트 챔피언이 @BaseAD@%의 공격력 %i:scaleAD%을 얻고 아군이 입힌 피해를 기록하기 시작합니다. 최고 기록을 경신할 때마다 8비트 챔피언의 공격력이 증가합니다.<br><br><row>(@MinUnits@) @AttackDamage@% %i:scaleAD%</row><br><row>(@MinUnits@) @AttackDamage@% %i:scaleAD%</row><br><row>(@MinUnits@) @AttackDamage@% %i:scaleAD% 및 경신 시 큰 보상을 받는 최종 최고 기록을 얻습니다.</row><br><br>보너스: @TFTUnitProperty.trait:TFT10_Trait_8bit_CurrentBonus@% %i:scaleAD% (@TFTUnitProperty.trait:TFT10_Trait_8bit_StackCount@/@NumHighScores@)',
  ...
  Set10_Edgelord: {
    ...
    desc: {
      ko: '이단아가 공격 속도를 얻습니다. 대상의 체력이 @HealthRatio*100@% 아래로 떨어지면 증가량이 두 배가 됩니다. 또한 사거리가 1칸인 이단아가 다음 기본 공격 시 돌진하면서 적을 베고 지나갑니다. <br><br><expandRow>(@MinUnits@) @AttackSpeed*100@% %i:scaleAS%</expandRow><br>',
  ...
  Set10_KDA: {
    apiName: 'Set10_KDA',
    desc: {
      ko: '전투 시작: 빛나는 칸에 있는 아군이 최대 체력과 주문력, 공격력을 얻습니다. K/DA 챔피언일 경우 증가량이 두 배가 됩니다.<br><br><expandRow>(@MinUnits@) 최대 %i:scaleHealth%의 +@BonusMaxHealth*100@% 및 @BonusAP@% %i:scaleAP%%i:scaleAD%</expandRow>',
    ...
    effects: [
      ...
      },
      {
        ...
        variables: {
          BonusAP: 60,
          BonusMaxHealth: 0.6000000238418579,
          ManaPerSecond: 10,
          '{158db106}': 2,
        },
      },
  ...
  Set10_Quickshot: {
    ...
    desc: {
      ko: '아군이 @TeamwideAttackSpeed*100@%의 공격 속도를 얻습니다.<br>속사포 챔피언은 기본 공격 시 중첩을 얻으며, 최대 @MaxStacks@회 중첩됩니다.<br><br><expandRow>(@MinUnits@) @PercentAS*100@% %i:scaleAS%</expandRow>',
  ...
  Set10_PopBand: {
    ...
    desc: {
      ko: '적을 처치하면 하트를 획득합니다. 플레이어 대상 전투에서 패배하면 더 많이 얻습니다. 매 @RoundCount@번째 플레이어 대상 전투에서 하트가 강력한 보상으로 전환됩니다. <br><br><expandRow>(@MinUnits@) 하트 획득 @PercentHeartRate@배</expandRow>',
  ...
  Set10_EDM: {
    apiName: 'Set10_EDM',
    desc: {
      ko: 'EDM 선택기를 사용해 EDM 챔피언을 샘플링하고 각각의 주파수를 확인합니다.<br><br>특정 주파수에서 EDM 챔피언은 샘플로 변신하여 변경된 효과가 적용된 스킬을 사용합니다.<br><br><row>(@MinUnits@) 샘플링 효과 @EDMstats*100@%</row><br><row>(@MinUnits@) 샘플링 효과 @EDMstats*100@%</row><br><row>(@MinUnits@) 샘플링 효과 @EDMstats*100@%, 주파수 @EDMtimereduction@초 증가</row><br><row>(@MinUnits@) 샘플링 효과 @EDMstats*100@%, 주파수 @EDMtimereduction@초 증가</row>',
