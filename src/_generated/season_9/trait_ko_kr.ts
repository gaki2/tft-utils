export const trait_9 = {
    ...
    'Set9_Zaun': {
    "apiName": "Set9_Zaun",
    "desc": "자운 유닛은 자신들만 사용할 수 있는 무작위 화학공학 개조체를 생성합니다. 유닛은 하나의 개조체만 장착할 수 있습니다. 개조체를 제거하려면 유닛을 판매하거나 대기석에 보내야 합니다.<br><br><row>(@MinUnits@) 화학공학 개조체 1개 획득</row><br><row>(@MinUnits@) 화학공학 개조체 2개 획득 </row><br><row>(@MinUnits@) 과충전 효과가 부여된 화학공학 개조체 3개 획득</row><br>",
    "effects": [
        {
            "maxUnits": 3,
            "minUnits": 2,
